...
// This view is for creating a new store category in the admin panel. It includes a form with a single input for the category name and buttons to save or cancel.
@section('content')
